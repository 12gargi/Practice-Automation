...
public interface ThirdStep {
	...
	String sortframe = "iframe.demo-frame.lazyloaded']";
	...
	//Spinner
	String spinerframe = "iframe.demo-frame.lazyloaded";
	...
	//ToolBar
	String toolbarframe = "iframe.demo-frame.lazyloaded";
	...
	//Datepicker
	String dateFrame = "iframe.demo-frame.lazyloaded";
	...
	//DragAndDrop
	String dragiframe = "iframe.demo-frame.lazyloaded";
	...
	//Draggable Box
	String Boxiframe = "iframe.demo-frame.lazyloaded";
